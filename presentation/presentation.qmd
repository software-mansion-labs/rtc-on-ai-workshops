...
**9:30** - start of workshops

**11:00** - 1st coffe break

**13:30** - lunch

**16:00** - 2nd coffe break

**17-17:30** - workshop finish
...
2. **ExecuTorch**
3. **ExecuTorch C++ API**
4. **Understanding the LLMs**
5. **Building LLM Runner**
6. **Speech-to-Text**
7. **Audio Recording & Transcription Implementation**
8. **Building Complete Application**
...
![](images/waveform.png){width="600"}
![](images/spectrogram.webp){width="400"}
![](images/mel-spectrogram.webp){width="400"}
![](images/log-mel-spectrogram.webp){width="400"}

<p style="font-size: 0.4em">
src: https://medium.com/data-science/audio-deep-learning-made-simple-part-2-why-mel-spectrograms-perform-better-aad889a93505
</p>

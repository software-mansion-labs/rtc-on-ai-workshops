...
int AudioRecorder::recordCallback(const void* inputBuffer, void* outputBuffer,
    ...
    try {
        ...
        // Debug: Print every 8000 frames (roughly every 0.5 seconds at 16kHz) to show it's working
...
void AudioRecorder::writeWavHeader(FILE* file, int sampleRate, int channels, int dataSize) {
    // WAV file header
